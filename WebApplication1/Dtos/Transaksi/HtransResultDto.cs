...
namespace DoranOfficeBackend.Dtos.Transaksi
{
    public class HtransResult
    {
        ...
        public virtual CommonResult? Masterpelanggan { get; set; }
        public virtual CommonResult? Mastergudang { get; set; }

        public virtual CommonResult? Sales { get; set; }
    }
    ...
    public class DtransResult
    {
        ...
        public virtual MasterbarangResult? Masterbarang { get; set; }
    }

    public class MasterbarangResult
    {
